...
// Mirrors app/.../ui/VoiceRecorder.kt verbatim — the :wear module is a
// separate Gradle module with a much smaller dependency footprint (no
// Compose Material3, no OkHttp), so it can't just depend on :app for this
// one class without pulling all of that in. Kept in sync by hand, same
// convention as every other cross-target duplication in this app.

...
/// Verbatim duplicate of `FamilyAgent/Audio/WAV.swift` — see that file's
/// doc comment (and the Android/desktop equivalents) for why. No shared
/// framework between the phone and watch targets, same discipline as the
/// wire-contract structs in `WatchProtocol.swift`.
enum WAV {
